...
class OldBarcodeScannerActivity : AppCompatActivity() {

    private var scanResults: EditText? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        scanResults = findViewById<View>(R.id.barcodeText) as EditText

        button.setOnClickListener { ActivityCompat.requestPermissions(this@OldBarcodeScannerActivity, arrayOf(Manifest.permission.WRITE_EXTERNAL_STORAGE), REQUEST_WRITE_PERMISSION) }
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<String>, grantResults: IntArray) {
        ...
        when (requestCode) {
            REQUEST_WRITE_PERMISSION -> if (grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(this@OldBarcodeScannerActivity, "Permission Denied!", Toast.LENGTH_SHORT).show()
            }
        }
    }
            ...
            try {
                ...
                if (detector!!.isOperational && bitmap != null) {
                    ...
                    for (index in 0 until barcodes.size()) {
                        ...
                        scanResults!!.setText( scanResults!!.text.toString() + code.displayValue)
                    ...
                    if (barcodes.size() == 0) {
                        scanResults!!.setText("Scan Failed ")
                    }
                } else {
                    scanResults!!.setText("Could not set up the Barcode detector!")
                }
            } catch (e: Exception) {
    ...
    companion object {
        ...
        fun newIntent(context: Context): Intent {
            return Intent(context, OldBarcodeScannerActivity::class.java)
        }
    }
